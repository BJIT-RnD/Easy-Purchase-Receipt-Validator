...
class InAppReceiptValidatorTests: XCTestCase {
    ...
    var mockProcessedFinalPayload: PayloadData?
    override func setUp() {
        super.setUp()
        ...
        receiptInfo = InAppReceiptValidator(receipt)
        ...
        guard let receiptInvalid = appleContainerInvalid?.AppleReceipt() else {
            return
        }
        invalidReceiptInfo = InAppReceiptValidator(receiptInvalid)
    }
